...
{
    public class WeatherForecastPaginatedListSpecification : Specification<Domain.WeatherForecasts.WeatherForecast>
    {
        public WeatherForecastPaginatedListSpecification(GetWeatherForecastListQuery query)
        {
            BuildCriteria(query);
